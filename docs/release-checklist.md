...
Use this checklist before cutting a public release for action-approval-skill.
...
- Exercise the CLI smoke path for `action-approval-skill` with the checked-in fixture.
